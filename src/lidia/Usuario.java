...
public class Usuario extends Jugador {
	...
	public Combinacion crearCombinacionSecreta() {
		...
		//1. Pedir color al usuario de la posicion 
				opcionColor = Teclado.leerRango(1, dificultad.getColores(), Teclado.Rango.AMBOSINCLUIDOS, "Posición " + (i + 1) + ":");
	...
	public Combinacion colocarPinchos(Combinacion combinacion, Combinacion combinacionSecreta) { 
		...
		do {		
			repetir = false;
			colocados = Teclado.leerRango(0, dificultad.getCasillas(), Teclado.Rango.AMBOSINCLUIDOS, "Introduzca el número de fichas "
					+ "que coinciden color y posición");		
			noColocados = Teclado.leerRango(0, (dificultad.getCasillas() - colocados), Teclado.Rango.AMBOSINCLUIDOS, "Introduce el número "
