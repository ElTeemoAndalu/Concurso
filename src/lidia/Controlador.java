...
public class Controlador {
	...
	public void Menu() {	
		...
		//2. Menú inicial, elige jugar, ver normas o salir del juego
			menu1 = Teclado.leerRango(1, 3, Teclado.Rango.AMBOSINCLUIDOS, "1. Juego nuevo\n2. Normas\n3. Salir");
		//	2.1. Jugar
		//		2.1.2. Menú elección de dificultad
			switch (menu1) {
			case 1: 
				System.out.println("Elija la dificultad");
				menu2 = Teclado.leerRango(1, 3, Teclado.Rango.AMBOSINCLUIDOS, "1. Fácil\n2. Medio\n3. Difícil");
		//			2.1.2.1. Menú de elección de modo fácil
				switch (menu2) {
				case 1: 
					System.out.println("Elegir modo fácil");
					menu3 = Teclado.leerRango(1, 2, Teclado.Rango.AMBOSINCLUIDOS, "1. Adivinar combinación\n2. Crear combinación");
					switch (menu3) {
