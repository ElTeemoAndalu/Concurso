...
public class Nicolast extends Participante{
	...
	public Nicolast() {
		...
		turno = 0;
		miIAu = new IA(Dificultad.DIFICIL);
	}
	...
	public byte[] crearCombPropuesta() {
		...
		miIAu.introducir_fila(miIAu.analisis_intento());
	...
	public byte[] crearCombSecreta() {
		...
		miIAu.introducir_cifrado(miIAu.comb_random(tableroRival, false), tableroRival);
